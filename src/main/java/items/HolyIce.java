...
public class HolyIce implements CustomItem {
	...
	public void onRightClick(Player p) {
		...
		p.addScoreboardTag("IceCooldown");
		Bukkit.getScheduler().runTaskLater(Plugin.getInstance(), () -> p.removeScoreboardTag("IceCooldown"), 80L);
